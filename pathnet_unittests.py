...
class ModuleFunctionsTest(tf.test.TestCase):
  ...
  correct_perceptron_output_2d = np.array( # Shape (4,5) - like input
	...
	with self.test_session():
  	...
  	perceptron_module_output_4d = perceptron_module(input_4d)
		self.assertAllEqual(perceptron_module_output_2d.eval(), correct_perceptron_output_2d)
		self.assertAllEqual(perceptron_module_output_4d.eval(), correct_perceptron_output_4d)
  	#print('perceptron_module works for 2d case: ', perceptron_module_output_2d.eval() == correct_perceptron_output_2d)
  	#print('perceptron_module works for 4d case: ', perceptron_module_output_4d.eval() == correct_perceptron_output_2d)
  ...
  correct_residual_perceptron_output_2d = correct_perceptron_output_2d + input_2d
	with self.test_session():
  	...
  	residual_perceptron_module_output_4d = residual_perceptron_module(input_4d)
		self.assertAllEqual(residual_perceptron_module_output_2d.eval(), correct_residual_perceptron_output_2d)
		self.assertAllEqual(residual_perceptron_module_output_4d.eval(), correct_residual_perceptron_output_4d)
  	...
  	#print('residual_perceptron_module works for 4d case: ', residual_perceptron_module_output_4d.eval() == correct_residual_perceptron_output_2d)
